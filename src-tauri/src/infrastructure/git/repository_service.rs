...
use crate::domain::repository_status::RepositoryStatusEntry;
use crate::interfaces::dto::app_error::AppErrorDto;

use super::diff_parser::{
    parse_unified_diff, DiffChangeType, DiffFile, DiffLineType,
};
...
impl GitRepositoryService {
    ...
    pub fn get_working_diff(
        ...
        let diff_output = GitExecutor::run(
            &repository_root,
    ...
    pub fn get_commit_diff(
        ...
        let diff_output = GitExecutor::run(&repository_root, &args).map_err(|error| {
